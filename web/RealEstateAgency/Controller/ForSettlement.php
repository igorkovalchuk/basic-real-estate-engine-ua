...
*/
class RealEstateAgency_Controller_ForSettlement extends RealEstateAgency_Controller_Base
{
    ...
    */
    private function insert() {
        ...
        $district_id = $this->filter->getDistrictId();
        
        $object = new RealEstateAgency_Object_Settlement();
        $object->setGlobalData( $this->getGlobalData() );
        $object->setObjectName( $object_name );
        // $object->setAreaId( $area_id );
        $object->setDistrictId( $district_id );
