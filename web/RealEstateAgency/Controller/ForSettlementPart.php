...
*/
class RealEstateAgency_Controller_ForSettlementPart extends RealEstateAgency_Controller_Base
{
    ...
    */
    private function edit() {
        $object = RealEstateAgency_Object_SettlementPart::loadById($this->getGlobalData(), $this->object_id);
        if ($object) {
    ...
    */
    ...
    private function loadData() {
        ...
        $list_3 = new RealEstateAgency_Object_SettlementPartList();
        $list_3->setGlobalData($globalData);
        
        if (! $filter->getSettlementId() ) {
            throw new Exception('List of settlement parts. Incorrect settlement identifier.');
        }
        
        $list_3->setSettlementId($filter->getSettlementId());
        $list_3->loadBy();
        $view->list_of_settlement_parts = $list_3;
    }
}
