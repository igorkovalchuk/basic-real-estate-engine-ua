...
require_once 'RealEstateAgency/Database/SettlementPart/All.php';

require_once 'Zend/Validate.php';
require_once 'Zend/Validate/Int.php';

class RealEstateAgency_Object_SettlementPart extends RealEstateAgency_Object_Obj
{
    private $obj_id = NULL;
    private $obj_name = '';
    private $parent_id = '';
    ...
    public function toString() {
        $str = 'RealEstateAgency_Object_SettlementPart: ';
    ...
    */
    public function loadById($globalData, $object_id) {
        ...
        $table = new RealEstateAgency_Database_SettlementPart_Table( array( 'db' => $db ) );
        $where = $db->quoteInto('obj_id = ?', $object_id);
        $rowset = $table->fetchAll($where);
        $row = $rowset->current();
        if ($row) {
            $new_object = new RealEstateAgency_Object_SettlementPart();
    ...
    */
    ...
    public static function deleteById($globalData, $object_id) {
        $object = RealEstateAgency_Object_SettlementPart::loadById($globalData, $object_id);
        if ($object) {
            $object->delete();
        }
    }
    ...
    public function insert() {
        ...
        if (RealEstateAgency_Object_SettlementPart::loadByNameAndParentId($this->getGlobalData(), $object_name, $parent_id)) {
