...
*/
class RealEstateAgency_Controller_ForDistrict extends RealEstateAgency_Controller_Base
{
    ...
    */
    ...
    /*
    input: object_name, area_id
    */
    private function insert() {
        
        $object_name = $this->object_name;
        $area_id = $this->filter->getAreaId();
        
        $object = new RealEstateAgency_Object_District();
        $object->setGlobalData( $this->getGlobalData() );
        $object->setObjectName( $object_name );
        $object->setAreaId( $area_id );
    ...
    */
    ...
    /*
    Load list of districts by area identifier;
    */
    private function loadData() {
        
// echo "LOAD DATA ".$this->filter->getAreaId();
        $view = $this->getGlobalData()->getView();
        $objectsList = new RealEstateAgency_Object_DistrictList();
        $objectsList->setGlobalData($this->getGlobalData());
        $objectsList->setAreaId($this->filter->getAreaId());
        $objectsList->loadForShow();
        $view->list_of_districts = $objectsList;
    }
